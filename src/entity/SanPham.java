...
public class SanPham implements Comparable<SanPham>{
	...
	public String toString() {
		...
		builder.append("SanPham [maSP=");
		builder.append(maSP);
		builder.append(", tenSP=");
		builder.append(tenSP);
		builder.append(", loaiSP=");
		builder.append(loaiSP);
		builder.append(", mauSac=");
		builder.append(mauSac);
		builder.append(", nhaCC=");
		builder.append(nhaCC);
		builder.append(", xuatSu=");
		builder.append(xuatSu);
		builder.append(", ngayNhap=");
		builder.append(ngayNhap);
		builder.append(", hanSuDung=");
		builder.append(hanSuDung);
		builder.append(", donVi=");
		builder.append(donVi);
		builder.append(", soLuong=");
		builder.append(soLuong);
		builder.append(", giaTMDV=");
		builder.append(giaTMDV);
		builder.append(", moTa=");
		builder.append(moTa);
		builder.append("]");
