...
public class GUIAdmin extends JFrame{
	...
	//QLNCC
	private QLNhaCCimpl dsNCC = new QLNhaCC(em);
	//QLTB
	private QLSanPhamimpl dsTB = new QLSanPham(em);
	//QLTK
	private QLNhanVienimpl mngAcc = new QLNhanVien(em);
	//QLMAU
	private QLMauimpl dsMau = new QLMau(em);
	//QLLoaiTB
	private QLLoaiSPimpl dsLSP = new QLLoaiSP(em);
	//QLXuatSU
	private QLXuatSuimpl dsXS = new QLXuatSu(em);
	private Box b2_1;
	...
	public GUIAdmin() {
		...
		bQLTB.add(b1 = Box.createHorizontalBox());
			...
			b1.add(b2_1 = Box.createVerticalBox());
				b2_1.add(b3_1 = Box.createHorizontalBox());
					b3_1.add(new JLabel("Ngày nhập"));
					dateChooser = new JDateChooser();
					b3_1.add(dateChooser);
